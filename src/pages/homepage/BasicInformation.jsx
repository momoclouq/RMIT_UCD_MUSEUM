const LeftPanel = () => {
    return (
        <div className="basis-full md:basis-2/5 bg-zinc-100 p-10 md:p-12 lg:p-28">
            <div className="p-8 text-4xl md:text-5xl text-center font-font-light">Date & Location</div>
...
const RightPanel = () => {
    return (
        <div className="basis-full md:basis-3/5 bg-zinc-100 p-10 md:p-12 lg:p-28">
